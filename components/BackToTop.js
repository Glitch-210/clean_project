  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: '0 4px 16px rgba(62,124,184,0.45)',
        opacity: visible ? 1 : 0,
        transform: visible ? 'translateY(0) scale(1)' : 'translateY(16px) scale(0.8)',
        transition: 'all 0.35s ease',
        pointerEvents: visible ? 'all' : 'none',
      }}
      onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-3px) scale(1.1)'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(62,124,184,0.6)'; }}
      onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0) scale(1)'; e.currentTarget.style.boxShadow = '0 4px 16px rgba(62,124,184,0.45)'; }}
      title="Back to top"
    >
