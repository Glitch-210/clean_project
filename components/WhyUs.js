...
function TiltCard({ w, i, visible }) {
  ...
  return (
    <div ref={tiltRef} className="whyus-card" style={{
      ...
      <div style={{ color: 'rgba(62,124,184,0.25)', fontSize: '48px', fontWeight: 900, lineHeight: 1 }}>{w.num}</div>
      <div style={{ color: '#3E7CB8', fontSize: '15px', fontWeight: 800, margin: '12px 0 8px' }}>{w.label}</div>
...
export default function WhyUs() {
  ...
  return (
    <section ref={ref} style={{ padding: '100px 64px', background: 'linear-gradient(135deg,#0A1628,#112240)', textAlign: 'center' }}>
      <div style={{ color: '#3E7CB8', fontSize: '12px', letterSpacing: '4px', textTransform: 'uppercase', marginBottom: '16px', fontWeight: 700 }}>Why Work With Us</div>
